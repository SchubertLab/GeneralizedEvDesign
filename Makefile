...
$(STRING_OF_BEADS_VACCINE): $(EPITOPES) $(CLEAVAGES)
	python design.py -v string-of-beads $(EPITOPES) $(CLEAVAGES) $(STRING_OF_BEADS_VACCINE) $(STRING_OF_BEADS_OPTS)
...
$(OPTITOPE_VACCINE): $(COVERAGE) $(AFFINITIES) $(ALLELES)
	python design.py -v optitope $(COVERAGE) $(AFFINITIES) $(ALLELES) $(OPTITOPE_VACCINE) $(OPTITOPE_OPTS)
